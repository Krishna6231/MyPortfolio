...
const projects = [
  {
    ...
    description: "A comprehensive full-stack expense tracking application with React Native frontend and NestJS backend. Features secure user authentication, expense categorization, and real-time data synchronization across devices.",
    features: [
    ...
    githubUrl: "https://github.com/krishna/spendly-frontend"
  },
  {
    title: "Training Center Registry API",
    description: "A Spring Boot REST API for managing training center registrations with MongoDB integration. Implements comprehensive validation, exception handling, and filtering capabilities for efficient data management.",
    features: [
  ...
  },
  {
    ...
    description: "A digital signature verification system implementing SCDSA algorithm on Raspberry Pi with AWS cloud integration. Provides secure vehicle-to-cloud communication with serverless architecture.",
    features: [
  ...
  },
  {
    ...
    description: "An intelligent machine learning system for detecting phishing URLs with over 96% accuracy using Logistic Regression. Features real-time classification and comprehensive evaluation metrics for cybersecurity applications.",
    features: [
    ...
    technologies: ["Python", "Machine Learning", "NLTK", "WHOIS API", "Seaborn"],
    githubUrl: "https://github.com/krishna/phishing-detection-system"
  },
  {
