  ...
  return (
    <nav
      className={`fixed top-0 left-0 right-0 z-50 transition-all duration-200 ${
        isScrolled
          ? "bg-warm-beige/90 backdrop-blur-sm shadow-sm"
          : "bg-warm-beige"
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center py-4">
          ...
          <div className="flex space-x-4">
            <a
              href="https://www.linkedin.com/in/krishna-modi-a53050256/"
              target="_blank"
            ...
            <a
              href="https://github.com/Krishna6231"
              target="_blank"
              rel="noopener noreferrer"
              className="text-warm-gray hover:text-dark-charcoal transition-colors duration-200"
            >
            ...
            <a
              href="mailto:krishnamodi.1524@gmail.com"
              className="text-warm-gray hover:text-dark-charcoal transition-colors duration-200"
            >
